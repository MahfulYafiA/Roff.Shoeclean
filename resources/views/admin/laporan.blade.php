...
<head>
    ...
    <style>
        ...
        @media print {
            @page { 
                size: A4 portrait; 
                margin: 15mm 15mm; /* Margin diperlebar untuk ruang bernapas */
            }
            ...
            /* ✨ PERBAIKAN WARNA HEADER (TIDAK ABU-ABU LAGI) ✨ */
            th { 
                font-size: 8.5px !important; 
                padding: 12px 8px !important; 
                background-color: #0f172a !important; /* Ganti ke gelap agar elegan atau sesuaikan */
            ...
            /* ✨ PERBAIKAN SUB TOTAL: AGAK KE KIRI (TIDAK MEPET KANAN) ✨ */
            th:last-child, td:last-child {
                padding-right: 40px !important; /* Jarak dari kanan diperbesar agar teks ke kiri */
        ...
        <header class="bg-[#0f172a]/80 backdrop-blur-xl border-b border-white/5 px-6 md:px-12 py-4 flex justify-between items-center shrink-0 z-40 no-print sticky top-0">
            <div class="flex items-center gap-3 md:gap-4">
                ...
                <h1 class="block font-black text-xl md:text-2xl uppercase tracking-tighter italic text-white leading-tight">
                    ROFF.<span class="text-{{ $accent }}-500">SHOECLEAN</span>
                </h1>
            </div>
        </header>
        ...
        <div class="p-6 md:p-12 flex-1 overflow-y-auto custom-scroll relative">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-10 relative z-10">
                ...
                <div class="glass-panel px-10 py-8 rounded-[2rem] text-right border border-{{ $accent }}-500/20">
                    <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1 group-hover:text-{{ $accent }}-400">Total Omset Keseluruhan</p>
