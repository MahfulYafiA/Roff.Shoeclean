                            ...
                            <tr class="hover:bg-slate-800/30 transition-all group {{ $l->status == 'Aktif' ? '' : 'opacity-50 grayscale hover:grayscale-0 hover:opacity-100' }}">
                                ...
                                <td class="px-8 py-5 text-right whitespace-nowrap">
                                    <div class="flex justify-end gap-3">
                                        {{-- ✨ FIX: GANTI admin.layanan.toggle MENJADI layanan.toggle --}}
                                        <form action="{{ route('layanan.toggle', $l->id_layanan) }}" method="POST" class="m-0 inline-block">
                                            @csrf
                                            @method('PATCH')
